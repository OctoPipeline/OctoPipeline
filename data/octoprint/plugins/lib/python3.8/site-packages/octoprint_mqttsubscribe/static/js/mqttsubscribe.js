...
$(function () {
  function MQTTSubscribeViewModel(parameters) {
    ...
    self.onBeforeBinding = function () {
      self.topics(
        self.settingsViewModel.settings.plugins.mqttsubscribe.topics()
      );
    };
    ...
    self.getAppKey = function () {
      ...
      OctoPrint.plugins.appkeys
        .authenticate("MQTT Subscribe", self.loginStateViewModel.userMenuText())
    ...
    self.copyKey = function (data) {
      copyToClipboard(
        data.settingsViewModel.settings.plugins.mqttsubscribe.api_key()
      );
    };
    ...
    self.addTopic = function (data) {
      ...
      self.settingsViewModel.settings.plugins.mqttsubscribe.topics.push(
        self.selected_topic()
      );
      $("#mqttTopicEditor").modal("show");
    };
    ...
    self.copyTopic = function (data) {
      self.selected_topic({
        topic: ko.observable(data.topic()),
