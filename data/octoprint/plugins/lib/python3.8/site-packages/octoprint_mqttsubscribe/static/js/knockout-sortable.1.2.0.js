      ...
      var createTimeout = setTimeout(function () {
          ...
          ko.utils.extend(sortable.options, {
            start: function (event, ui) {
              ...
              dataSet(
                el,
                INDEXKEY,
                ko.utils.arrayIndexOf(ui.item.parent().children(), el)
              );
            ...
            receive: function (event, ui) {
              ...
              if (dragItem) {
                ...
                if (sortable.dragged) {
                  dragItem =
                    sortable.dragged.call(this, dragItem, event, ui) ||
                    dragItem;
                }
              }
            },
            update: function (event, ui) {
              ...
              if (
                (item && this === parentEl) ||
                (!hasNestedSortableFix && $.contains(this, parentEl))
              ) {
                //identify parents
                ...
                if (sortable.beforeMove || sortable.afterMove) {
                  arg = {
                    ...
                    sourceParentNode:
                      (sourceParent && ui.sender) || el.parentNode,
                ...
                if (sourceParent) {
                  $(
                    sourceParent === targetParent ? this : ui.sender || this
                  ).sortable("cancel");
                }
        ...
        if (sortable.isEnabled !== undefined) {
          ko.computed({
            read: function () {
              $element.sortable(
                unwrap(sortable.isEnabled) ? "enable" : "disable"
              );
            },
            disposeWhenNodeIsRemoved: element,
          });
  ...
  ko.bindingHandlers.draggable = {
    init: function (
      ...
      var value = unwrap(valueAccessor()) || {},
        ...
        connectClass =
          value.connectClass || ko.bindingHandlers.draggable.connectClass,
        isEnabled =
